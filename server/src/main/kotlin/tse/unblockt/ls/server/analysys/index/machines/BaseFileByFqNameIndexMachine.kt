...
abstract class BaseFileByFqNameIndexMachine(project: Project) : IndexMachine<FqName, IndexFileEntry> {
    ...
    override val attribute: DB.Attribute<String, FqName, IndexFileEntry> = DB.Attribute(
        "package_to_file",
        metaToString = { it },
        stringToMeta = { it },
        keyToString = {
